...
export default function InfiniteScroll({
  ...
  return (
    <div
      className="relative flex items-center justify-center w-full overflow-hidden overscroll-none border-t-2 border-b-2 border-t-dotted border-b-dotted border-transparent rounded-2xl"
      ref={wrapperRef}
      style={{ maxHeight }}
    >
